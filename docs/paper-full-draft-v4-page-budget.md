...
1. **Problem and representation.** We connect maintenance-constrained statistics design with workload-specialized, design-parametric execution of the supported native CE semantics. The formulation separates selected definitions, DBMS-specific physical realization, frozen payloads, and fresh realization.
...
**Table T3: Maintenance-budget design outcomes.** Local optimum is limited to the audited ADD/DROP/SWAP neighborhood under fixed payload and precedence.
...
| DMV optimization realization | 36 MCV + 34 FD | 11 MCV + 12 FD | 43.724603; 29.158543 / 14.566060 | 7.83651388676e298 | 47 ADD, 23 DROP, 1,081 SWAP; local optimum |
...
PostgreSQL-specific elements include GreedyCover, OID precedence, payload formats, MCV-to-FD ordering, and `ANALYZE` realization behavior. The broader abstractions are workload specialization, design-parametric executable semantics, dual oracles, realization boundaries, and maintenance-constrained design.
